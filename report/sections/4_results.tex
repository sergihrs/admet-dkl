...
\subsection{SV-DKL vs. XGBoost: Overcoming the Mismatch in Inductive Biases}
...
\begin{figure}[h]
    ...
    \caption{Training vs. Validation MAE per epoch for the XGBoost ensemble. The plot illustrates the struggle with this mismatch in inductive biases: tree-based models rapidly memorize the small $N$ training set, while generalization on the validation set severely plateaus despite extreme regularization.}
